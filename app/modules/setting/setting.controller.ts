...
router.get("/public", catchAsync(async (_req, res) => {
  ...
  const { storeName, phone, email, storeAddress, currency, standardShippingFee, freeShippingThreshold, isCodActive, isBankActive, isQrActive, facebookUrl, instagramUrl, youtubeUrl, logoUrl, description } = all as any;
