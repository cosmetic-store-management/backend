import Attribute, { type AttributeDocument, type IAttribute } from "../../models/attribute.schema.js";
...
export const findByCode = (code: string) =>
  Attribute.findOne({ code });

export const findOneBy = (query: Query) =>
  Attribute.findOne(query);

export const create = (data: Partial<IAttribute>) =>
  Attribute.create(data);

export const save = (attr: AttributeDocument) =>
  attr.save();
