...
const generateAccessToken = (user) => jwt.sign({ id: user._id, role: user.role }, getAccessSecret(), 
// eslint-disable-next-line @typescript-eslint/no-explicit-any
{ expiresIn: ACCESS_TOKEN_EXPIRY });
const generateRefreshToken = (user) => jwt.sign({ id: user._id }, getRefreshSecret(), 
// eslint-disable-next-line @typescript-eslint/no-explicit-any
{ expiresIn: REFRESH_TOKEN_EXPIRY });
// ── Auth core ─────────────────────────────────────────────────────────────────
export const generateTokensForOAuth = async (user) => {
...
export const getCurrentUser = (user) => mapUser(user);
