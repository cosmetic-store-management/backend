...
router.get("/public", catchAsync(async (_req, res) => {
    ...
    const { storeName, phone, email, storeAddress, currency, isCodActive, isBankActive, isQrActive, facebookUrl, instagramUrl, youtubeUrl, tiktokUrl, zaloUrl, logoUrl, favicon, description, bankName, bankAccountNumber, bankAccountName, bankQrCodeUrl, } = all;
...
router.get("/public/stats", catchAsync(async (_req, res) => {
    try {
